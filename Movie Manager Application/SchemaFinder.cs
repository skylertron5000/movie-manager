...
class SchemaFinder
{
    public static void showSchema()
    {
        ...
        using (SqlConnection conn = new SqlConnection(@"Data Source=coursemaster1.csbchotp6tva.us-east-2.rds.amazonaws.com,1433;Initial Catalog=CSCI1630;User ID=rw1630;Password=Project!;"))
        {
            conn.Open();
